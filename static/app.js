...
async function openDetail(id){
 ...
 $("#note-form").onsubmit=async e=>{e.preventDefault();const form=new FormData(e.target);await api("/api/projects/"+id+"/notes",{method:"POST",body:form});await refresh();openDetail(id);toast("Note and attachments added")};
}
